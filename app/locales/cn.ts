...
const cn = {
  WIP: "支持联网问答,GPT4绘画插件等功能待开放...",
  Error: {
    Unauthorized:
      "## ChatGPT多功能联网版\n本项目开发初衷仅未学术交流使用，非强制收费项目\n\n温馨提示🥳:前期已付款用户重新输入授权码即可\n授权码获取方法:\n1.获取授权码可联系微信免费获取\n2.微信支付宝自由付款5-10元任意金额\n付款地址：[立即付款](http://aai.yjie.fun/10.jpg)\n\n功能介绍:可制作PPT,思维导图,论文速写,论文降重,搜题,查找互联网隐藏资源等功能...\n\n付款时务必备注您的微信号\n\n客服微信:Yueyi_Wife",
  },
  ChatItem: {
  ...
  Store: {
    ...
    BotHello: "> 全设备桌面端下载:[立即前往](http://aai.yjie.fun/app)\n\n联网搜索功能:点击下方地球转为🌐即为开启。\n\n不知道如何提问？试试问答模板在线生成:[立即使用](http://v.yjie.fun/)",
    Error: "出错了，稍后重试吧",
    Prompt: {
